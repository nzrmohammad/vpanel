...
BOT_CONFIGS = {
    ...
    # ==========================================
    # 🤖 تنظیمات هوشمند و هشدارها (جدید)
    # ==========================================
    'warning_days_before_expiry': 
    {
        'category': 'automation', 'title': '⚠️ روز شروع هشدار انقضا', 'type': 'int',
        'desc': 'تعداد روز مانده به انقضا برای شروع ارسال پیام هشدار', 'def': '3'
    },
    'inactive_days_threshold': 
    {
        'category': 'automation', 'title': '💤 روز تشخیص عدم فعالیت', 'type': 'int',
        'desc': 'اگر کاربر این تعداد روز متصل نشود، پیام یادآوری ارسال می‌شود', 'def': '7'
    },
    'emergency_volume_gb': 
    {
        'category': 'automation', 'title': '🎁 مقدار حجم اضطراری (GB)', 'type': 'float',
        'desc': 'مقدار حجمی که هنگام اتمام حجم به عنوان هدیه داده می‌شود', 'def': '1.0'
    },
